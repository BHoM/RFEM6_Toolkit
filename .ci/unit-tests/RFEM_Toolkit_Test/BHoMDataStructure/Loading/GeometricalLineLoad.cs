...
namespace RFEM_Toolkit_Test.Elements
{
    ...
    public class GeometricalLineLoad_test
    {
        ...
        public void InitializeOpenings()
        {
            ...
            loadList1 = new List<GeometricalLineLoad>() { load_force_0_h, load_force_0_i, load_force_0_h_loc, load_force_0_i_loc, load_force_0_h_proj, load_force_0_i_proj };

            //load_force_0_h = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100,null,null,"");
            //load_force_0_i = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");
            //load_force_0_r = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");

            //// Line Loads
            //load_force_0_h_proj = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");
            //load_force_0_i_proj = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");
            //load_force_0_r_proj = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");

            //load_force_0_h_loc = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");
            //load_force_0_i_loc = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");
            //load_force_0_r_loc = BH.Engine.Structure.Create.GeometricalLineLoad((Line)panel1.ExternalEdges[0].Curve, loadcase, Vector.XAxis * 100, null, null, "");
