...
{
    public class RFEM6AdapterV12_11 : RFEM6AdapterBase
    {
        ...
        [Description("Adapter for RFEM6 using Dlubal Web Service API version 6.12.11 or newer.")]
        ...
        [Output("adapter", "The created RFEM6 adapter for API version 6.12.11 or newer.")]
